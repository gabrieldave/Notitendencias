    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid min-w-0 gap-8 lg:grid-cols-2 lg:gap-10">
          <div className="flex min-h-[32rem] min-w-0 flex-col rounded-3xl border border-slate-200/90 bg-white p-8 shadow-soft sm:p-10">
            ...
            <p className="mt-3 text-sm font-medium text-slate-600">Ideal para explorar la plataforma.</p>
            <ul className="mt-8 flex flex-1 flex-col gap-4 text-base leading-snug text-slate-700">
              {freeItems.map((item) => (
            ...
            <Link
              href="/#newsletter"
              className="mt-auto flex w-full min-h-[52px] items-center justify-center rounded-2xl border-2 border-slate-200 bg-white px-6 py-3.5 text-base font-black text-brand-navy transition hover:border-brand-navy hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2"
            >
              Comenzar gratis
            </Link>
          </div>

          <div className="relative flex min-h-[32rem] min-w-0 flex-col overflow-hidden rounded-3xl border-2 border-brand-orange bg-gradient-to-b from-brand-navy via-brand-navy to-slate-950 p-8 text-white shadow-lift sm:p-10">
            ...
            <p className="mt-2 text-sm font-medium text-white/80">Ideal para creadores, emprendedores y negocios.</p>
            <ul className="mt-6 flex flex-1 flex-col gap-4 text-base leading-snug text-white/95">
